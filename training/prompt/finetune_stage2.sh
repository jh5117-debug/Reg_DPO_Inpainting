#!/bin/bash
# DiffuEraser Stage 2 Finetune (with Caption/Prompt support)
...
# Change to your finetuned Stage 1 converted weights path
FINETUNED_STAGE1="/home/hj/Train_Diffueraser_prompt/converted_weights/finetuned-stage1"
