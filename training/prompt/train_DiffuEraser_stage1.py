...
from dataset.finetune_dataset_caption import FinetuneDatasetWithCaption
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to merged caption YAML file. If not provided, uses 'clean background' as caption.",
    )
    parser.add_argument(
...
def main(args):
    ...
    train_dataset = FinetuneDatasetWithCaption(args, tokenizer)
